...
require $_SERVER['DOCUMENT_ROOT'] . '/inventory_system/controllers/AuthController.php';
require $_SERVER['DOCUMENT_ROOT'] . '/inventory_system/controllers/RegisterController.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $error = RegisterController::register(
        $conn,
        $table_users,
        $user_username,
        $user_password,
...
<body>
  ...
  <?php
  require $_SERVER['DOCUMENT_ROOT'] . '/inventory_system/components/js_script.php';
