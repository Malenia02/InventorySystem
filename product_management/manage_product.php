                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-sm toggleProductStatusBtn <?= ($p['status']=='active')?'btn-danger':'btn-success' ?>"
                              data-id="<?= $p['product_id'] ?>"
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-md-4 text-center">
                          ...
                          <img id="addProductPhotoPreview" src="/inventory_system/assets/uploads/products/images.jpeg"
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-md-4 text-center">
                          ...
                          <img id="editProductPhotoPreview" src="/inventory_system/assets/uploads/products/images.jpeg"
                               style="width:150px;height:150px;object-fit:cover;">
                          <input type="file" class="form-control mt-2" name="photo" accept="image/*">
                        </div>
                        <div class="col-md-8">
